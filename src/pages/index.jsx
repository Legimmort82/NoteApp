...
export default function Home() {
  return (
    <Layout>
      <div className="bg-total dark:bg-total-dark h-screen flex relative overflow-clip">
        <div className="bg-sidebar w-[120px] h-[120px] rounded-[50%] absolute top-[-60px] right-[-60px] shadow-md shadow-gray-400 "></div>



        <div className="pl-[20px] pr-[20px] flex flex-col items-center">
          <h1 className="text-[80px] font-bold mb-3">Welcome to Note Smart</h1>
